...
$sql="update tbllaptops set laptop_Vimage5=:vimage where laptop_Id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Laptop Image 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Laptop Image 5 Details</div>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT laptop_Vimage5 from tbllaptops where tbllaptops.laptop_Id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
