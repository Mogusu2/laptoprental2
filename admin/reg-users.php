...
{				?>
	...
	<td><?php echo htmlentities($result->dob);?></td>
											<td><?php echo htmlentities($result->user_ser_Address);?></td>
											<td><?php echo htmlentities($result->user_City);?></td>
											<td><?php echo htmlentities($result->user_Country);?></td>
											<td><?php echo htmlentities($result->user_RegDate);?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
