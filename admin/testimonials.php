...
$eid=intval($_GET['eid']);
$status="0";
$sql = "UPDATE tbltestimonial SET testimonial_Status=:status WHERE  testimonial_Id=:eid";
						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT tblusers.user_FullName,tbltestimonial.user_Email,tbltestimonial.Testimonial,tbltestimonial.testimonial_PostingDate,tbltestimonial.testimonial_status,tbltestimonial.testimonial_Id from tbltestimonial join tblusers on tblusers.user_Email=tbltestimonial.user_Email";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>
										<tr>
											...
											<td><?php echo htmlentities($result->testimonial_PostingDate);?></td>
