...
{
$id=$_GET['del'];
$sql = "delete from  tblsubscribers  WHERE subscriber_Id=:id";
...
<head>
	...
	<title>Laptop Rental Portal |Admin Manage Subscribers   </title>
...
{				?>
										<tr>
											...
											<td><?php echo htmlentities($result->subscriber_Email);?></td>

											<td><?php echo htmlentities($result->subscriber_PostingDate);?></td>
