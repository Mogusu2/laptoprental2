...
{
$id=$_GET['del'];
$sql = "delete from tblbrands  WHERE brand_Id=:id";
...
<head>
	...
	<title>Laptop Rental Portal |Admin Manage Brands   </title>
...
{				?>
										<tr>
											...
											<td><?php echo htmlentities($result->brand_CreationDate);?></td>
											<td><?php echo htmlentities($result->brand_UpdationDate);?></td>
