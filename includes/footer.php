<?php
if(isset($_POST['emailsubsciber']))
{
$subscriberemail=$_POST['subscriberemail'];
$sql ="SELECT subscriber_Email FROM tblsubscribers WHERE subscriber_Email=:subscriberemail";
$query= $dbh -> prepare($sql);
$query-> bindParam(':subscriberemail', $subscriber_Email, PDO::PARAM_STR);
$query-> execute();
...
$sql="INSERT INTO  tblsubscribers(subscriber_Email) VALUES(:subscriberemail)";
$query = $dbh->prepare($sql);
$query->bindParam(':subscriberemail',$subscriber_Email,PDO::PARAM_STR);
$query->execute();
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; 2024 Laptop Rental Portal. </p>
        </div>
      </div>
    </div>
  </div>
