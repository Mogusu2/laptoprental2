    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logg21.png" alt="image"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">jamiemaroko41@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a href="tel:+639079373999">+254796083899</a> </div>
...
echo "Welcome To Laptop rental portal";
 } ?>
          </div>
        </div>
      </div>
...
$sql ="SELECT user_FullName FROM tblusers WHERE user_Email=:email ";
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->user_FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
        ...
        <div class="header_search">
          ...
          <form action="laptop-listing.php" method="get" id="header-search-form">
